...
$name=$_GET['name'];
$sql=mysql_query("SELECT user_lastname from user where user_firstname='$name'");
$sql1=mysql_query("SELECT user_type from user where user_firstname='$name'");
$sql2=mysql_query("SELECT user_photo from user where user_firstname='$name'");
